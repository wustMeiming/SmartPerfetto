...
> 关联文档：[`agent-runtime.md`](../../architecture/agent-runtime.md) · 引入提交 `a212ca89 feat: add four-agent runtime contract`
...
【唯一真相源】docs/archive/architecture-reviews/agent-runtime-abstraction-review.md
