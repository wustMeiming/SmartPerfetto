...
- `docs/rendering_pipelines/S01-S14*.md` 是固定上游 commit 的 Android 17 教学真相；
- `backend/skills/pipelines/index.yaml` 映射 13 个具体 rendering type 与 31 个检测条目；
...
ANGLE、PIP、HWC overlay 等特征误报为应用的主出图类型。构建时 S01-S14 会复制到
